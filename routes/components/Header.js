    ...
    return (
        <div className="header-wrapper">
            <div className="header-banner">
                ...
                <div className="logo" > <span style={{ color: 'red' }}>Dardania</span> Radio</div>

                {query === 'undefined' || query === '' ? '' : <div className="header-title__search" ><span style={{ color: 'red' }}>{query}</span> <span>Radio Station</span></div>}

                <div className="title-search">
                    <span className="title-search1"> <span style={{ color: 'red' }}>Streaming</span> live</span> <button className={isExpanded ? 'title-search__btn1' : 'title-search__btn'} onClick={handleExpand}> {isExpanded ? <IoCloseSharp style={{ fontSize: '22px', color: 'red' }} /> : <IoSearchSharp style={{ fontSize: '22px' }} />}</button>
                </div>
                ...
                <div className="header-main__text">
                    <ul>
                        <li>
                            ...
                            <h1>and Am/Fm stations.</h1>
                        </li>

                        <li className="header-main__p">
                            <p>Enjoy some of the finest radio stations from Albania and Kosova .</p>
