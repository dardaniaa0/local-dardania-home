        ...
        <>
            <div className="content-recommend">
                <div className="player-content">
                    <div className="logo1">
                        <li className="logo1-text"><span style={{ color: 'red' }}>Dardania</span> Radio</li>
                        <li> <span className="title-search1"> <span style={{ color: 'red' }}>Streaming</span> Live From Ghana</span> </li>
                    </div>
                    ...
                    <div className="player-content__items">
                        ...
                        <div className="player-text">
                            <li className="player-text__items"><div>{name}</div> {Frequency === '' ? '' : <div> <span>{Frequency}</span> <span style={{ color: 'red' }}>MHz</span></div>} <div className="player-text__anime" style={animateStream()}><img src={equalizer} alt="icon" /></div></li>
